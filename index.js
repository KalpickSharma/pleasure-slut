...
function incrementDiamond(x){
    diamond.innerHTML = parseFloat(diamond.innerHTML) + x*20
...
function playAudio() {
    new Audio("assets/moan.mp3").play();
  }
...
function playBuy() {
    new Audio("assets/slaps.mp3").play();
...
function changeMinerScr() {
    switch (true) {
        case parseFloat(minerLevel.innerHTML)<2:
            document.querySelector(".miner-icon").src ="./assets/miners/dig .jpg"
          break;
